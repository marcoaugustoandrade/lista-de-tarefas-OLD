...
let url = 'http://localhost:3009/tarefas';
...
function alterarTarefa(tarefa) {
  ...
  return new Promise(function (resolve, reject) {
    let url = 'http://localhost:3009/tarefas/' + tarefa.id;
    let requisicao = new XMLHttpRequest();
    requisicao.onreadystatechange = function () {
...
function deletarTarefa(id) {
  ...
  return new Promise(function(resolve, reject){
    let url = 'http://localhost:3009/tarefas/' + id;
    let requisicao = new XMLHttpRequest();
    requisicao.onreadystatechange = function () {
      if (requisicao.readyState == 4){
        if (requisicao.status == 200) {
...
function listarTarefas(filtro) {
  ...
  return new Promise(function (resolve, reject) {
    let url = 'http://localhost:3009/tarefas/filtrar/' + filtro;
    let requisicao = new XMLHttpRequest();
    requisicao.onreadystatechange = function () {
      if (this.readyState == 4) {
        if (this.status == 200) {
